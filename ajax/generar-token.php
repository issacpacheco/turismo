<?php
    ...
    $ch = curl_init();
	curl_setopt($ch, CURLOPT_URL,"https://live.api.holacash.mx/v2/tokenization/payment_token");
    ...
    $ch = curl_init();
	curl_setopt($ch, CURLOPT_URL,"https://live.api.holacash.mx/v2/transaction/charge");
	curl_setopt($ch, CURLOPT_POST, true);
    curl_setopt($ch, CURLOPT_HTTPHEADER, array('X-Api-Client-Key: pub_live_2wT5g54n.EWdUiXZq86EYYdMs1XgzJZUG1vxp1X8W',
                                                'X-Cash-Anti-Fraud-Metadata: ',
                                                'Content-Type: application/json')); 
